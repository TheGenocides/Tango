...
class social(commands.Cog):
    ...
    def __init__(self, bot):
        ...
        self.video_error = discord.Embed(color=discord.Color.red()).set_footer(
    ...
    @commands.command(
        "profile", description="Profile command can let you see your channel stats!"
    )
    ...
    async def _profile(self, ctx):
        ...
        await ctx.send(
            ...
            .set_author(name=f"{ctx.author.name} (@{data[1]})", icon_url=data[3])
            .set_footer(
                text=f"Source: @{data[1]} | ID: {ctx.author.id}", icon_url=data[3]
            )
            .add_field(name="<:Follow_Icon:885087513058902057> Subs", value=data[4])
            .add_field(
                name="<:blurple_camera:875659362331394058> Videos", value=data[8]
            )
            .add_field(name="🫂 Views", value=data[7])
            .add_field(name="<:likes:875659362343993404> Likes", value=data[5])
            .add_field(name="<:dislikes:875659362264309821> Dislikes", value=data[6])
            ...
            .add_field(name="🫂 Gender", value=info[1])
            .add_field(name="📧 email", value=info[3])
            .add_field(name="🔑 Password", value="||[Password Redacted]||", inline=False)
            .add_field(name="⌛ Account Age", value=info[5])
        )
    ...
    async def _start(self, ctx):
        ...
        if channel_data != None:
            await ctx.send(
                embed=discord.Embed(
                    description="You already made an account", color=discord.Color.red()
                )
            )
            return
        ...
        while True:
            try:
                ...
                inter = await embed_message.wait_for_button_click(
                    lambda inter: inter.channel == ctx.channel, timeout=20
                )
                if inter.author != ctx.author:
                    ...
                    await inter.reply(
                        type=7,
                        embed=discord.Embed(
                            description="Aborting...", color=discord.Color.red()
                        ),
                        components=[],
                    )
                    return
        ...
        try:
            ...
            message = await embed_message.edit(
                embed=discord.Embed(
                    title="Step 1",
                    description="Type your UserName. This name will get displayed in your profile and whenever someone check your channel display.",
                    color=self.embed_color,
                )
                .add_field(
                    name="Requirements!",
                    value="\> Type your UserName name without any special characters!\n\> Minimum of 5 to 15 characters!\n\> Make sure the name is not exist yet.",
                )
                .set_footer(
            ...
            await cur.execute(
                "SELECT member_id FROM channel WHERE channel = ?", (msg.content,)
            )
                    ...
                    SelectMenu(
                        ...
                        options=[
                            SelectOption(
                                ...
                                "value 1",
                                emoji="\U00002642",
                                description="A Male Gender Option",
                            ),
                            SelectOption(
                                "Female",
                                "value 2",
                                emoji="\U00002640",
                                description="A Female Gender Option",
                            ),
                            SelectOption(
                                "NonBinary",
                                "value 3",
                                emoji="\U00002b1c",
                                description="A Nonbinary option",
                            ),
                        ],
                    )
                ],
            ...
            while True:
                try:
                    inter = await embed_message.wait_for_dropdown(
                        lambda inter: inter.author == ctx.author, timeout=30
                    )
                    if inter.author != ctx.author:
                        await inter.reply(
                            embed=discord.Embed(
            ...
            label = "".join(
                [option.label for option in inter.select_menu.selected_options]
            )
            ...
            password = await self.bot.wait_for(
                ...
                and isinstance(x.channel, discord.DMChannel),
                timeout=60,
            )
            ...
            await ctx.author.send(
                f"Your password is ||{password.content}|| Continue to {ctx.channel.mention}!"
            )
            ...
            confirm = await ctx.reply(
                ...
                .add_field(name="<:Follow_Icon:885087513058902057> Subs", value=0)
                .add_field(name="<:blurple_camera:875659362331394058> Videos", value=0)
                .add_field(name="🫂 Views", value=0)
                .add_field(name="<:likes:875659362343993404> Likes", value=0)
                .add_field(name="<:dislikes:875659362264309821> Dislikes", value=0)
                .add_field(name="\u200b", value="\u200b")
                .add_field(
                    name="Account Information",
                ...
                .add_field(name="🫂 Gender", value=label)
                .add_field(name="📧 email", value=email)
                .add_field(
                    name="🔑 Password", value="||[Password Redacted]||", inline=False
                )
                .add_field(name="⌛ Account Age", value=f"<t:{int(age)}:F>"),
                components=[buttons],
            )
            ...
            async def _Green(inter):
                ...
                await cur.execute(
                    ...
                    (
                        ctx.author.id,
                        msg.content,
                        "Set a new description, banner, using p!setting command! also you can change channel name, email, password, and gender so dont you worry!",
                        str(ctx.author.avatar_url),
                        0,
                        0,
                        0,
                        0,
                ...
                await inter.reply(
                    ...
                    .add_field(name="<:Follow_Icon:885087513058902057> Subs", value=0)
                    .add_field(
                        name="<:blurple_camera:875659362331394058> Videos", value=0
                    )
                    .add_field(name="🫂 Views", value=0)
                    .add_field(name="<:likes:875659362343993404> Likes", value=0)
                    .add_field(name="<:dislikes:875659362264309821> Dislikes", value=0)
            ...
            await ctx.send(
                embed=discord.Embed(
                    title="Timeout!", color=discord.Color.red()
                ).set_footer(text="You are too slow, Use the command again!")
            )
        ...
        try:
            ...
            if cur:
                ...
                if len(title.content) < 4 or len(title.content) > 100:
                    await ctx.send(
                        embed=discord.Embed(color=discord.Color.red()).set_footer(
                ...
                try:
                    if (
                        title.attachments
                        or requests.get(title.content).status_code <= 200
                    ):
                        await ctx.send(
                            embed=discord.Embed(
                ...
                descriptions = await self.bot.wait_for(
                    "message",
                    check=lambda x: x.author == ctx.author and x.channel == ctx.channel,
                    timeout=120.0,
                )
                ...
                try:
                    if (
                        ...
                        or requests.get(description.content).status_code <= 200
                    ):
                        await ctx.send(
                            embed=discord.Embed(
                ...
                attach = await self.bot.wait_for(
                    "message",
                    check=lambda x: x.author == ctx.author and x.channel == ctx.channel,
                    timeout=120.0,
                )
                ...
                await cur.execute(
                    "SELECT channel FROM channel WHERE member_id=?", (ctx.author.id,)
                )
                ...
                if attach.attachments:
                    for x in attach.attachments:
                        if len(attach.attachments) > 1:
                            await ctx.send(
                                embed=discord.Embed(
                                    color=discord.Color.red()
                                ).set_footer(text="Please send 1 video only!")
                            )
                            return
                        ...
                        if x.content_type in ["video/mp4", "video/mp3", "image/gif"]:
                            em = await ctx.send(
                                embed=discord.Embed(
                                    title="Posting...", color=self.embed_color
                                ).set_footer(text="Might take a few seconds!")
                            )
                            ...
                            await em.edit(
                                embed=discord.Embed(
                                    title="Done!",
                                    description="Are you sure you want to upload this video?\nClick the green button to upload this video or click the red button to cancelled this process!",
                                    color=self.embed_color,
                                ),
                                components=[
                                    ActionRow(
                            ...
                            @on_click.not_from_user(
                                ctx.author, cancel_others=True, reset_timeout=True
                            )
                            ...
                            async def _green(inter):
                                ...
                                cur = await helper.cursor(con)
                                await cur.execute(
                                    "SELECT videos FROM channel WHERE member_id=?",
                                    (ctx.author.id,),
                                )
                                ...
                                data += 1
                                await cur.execute(
                                    "UPDATE channel SET videos = ? WHERE member_id=?",
                                    (data, ctx.author.id),
                                )
                                await con.commit()
                                await cur.close()
                                ...
                                await log.send(
                                    ctx.author.mention,
                                    embed=discord.Embed(
                                        title="New Video Has Been Posted",
                                        description=f"{ctx.author.mention} has posted a video! Please wait 5 to 10 minutes untill it get verified!",
                                ...
                                await verified.send(
                                    "Someone has posted a video! Verified now!",
                                    embed=discord.Embed(
                                        title=title.content,
                                        url=x,
                    ...
                    async def _green(inter):
                        ...
                        await verified.send(
                            ...
                            .add_field(
                                name="<:likes:875659362343993404> Likes", value=0
                            )
                            .add_field(name="🫂 Views", value=0)
                            .add_field(
                                name="<:dislikes:875659362264309821> Dislikes", value=0
                            ),
                        )

                        await verified.send(attach.content)
    ...
    async def _videos(self, ctx):
        ...
        data = await helper.find_in_video(
            ctx.author.id, False, mode="all", verified="y"
        )
        channel_data = await helper.find_in_channel(ctx.author.id)
        info = await helper.find_in_info(ctx.author.id)
        ...
        if video > 1 and len(data) > 1:
            ...
            msg = await ctx.send(
                embed=discord.Embed(
                    title="..."
                    if not ctx.channel.is_nsfw() and data[i][14] == "y"
                    else data[i][1],
                    url=""
                    if not ctx.channel.is_nsfw() and data[i][14] == "y"
                    else data[i][3],
            ...
            file = await ctx.send(
                "Search this video in nsfw channel!"
                if data[i][14] == "y"
                else data[i][3],
                components=[
                    ActionRow(
            ...
            async def _Left_button(inter):  # Left Button
                nonlocal i
                if i == 0:
                    i = len(data) - 1
            ...
            @on_click.matching_id("select-button")
                ...
                try:
                    while True:
                        ...
                        if page > video and isinstance(page, int):
                            await ctx.send(
                                f"You only have **{video}** not {select.content}"
                            )
                            await asyncio.sleep(0.5)

                        elif page <= 0 and isinstance(page, int):
                            await ctx.send(
                                "Number cannot be minus, zero, or letters. Enter it again!"
                            )
                            await asyncio.sleep(0.5)
                            ...
                            await file.edit(
                                content="Search this video in nsfw channel!"
                                if data[i][14] == "y"
                                else data[i][3],
                                components=[
                                    ActionRow(
            ...
            async def _No_check(inter):
                if progress == True:
                    await inter.reply(
                        "Woah slowdown there mate! I asked you a question, answer it before clicking another button!",
                        ephemeral=True,
                    )
            ...
            file = await ctx.send(
                "Search this video in nsfw channel!"
                if data[i][14] == "y" and not ctx.channel.is_nsfw()
                else data[i][3],
                components=[
                    ActionRow(
                        Button(
    ...
    async def _view(self, ctx, *, video_ID):
        ...
        if not data:
            await ctx.send(
                embed=discord.Embed(
                    description="You put a wrong video ID!", color=discord.Color.red()
                )
            )
            return
        ...
        if data[16] == "n":
            await ctx.send(
                embed=discord.Embed(
                    description="This video isnt verified yet!",
                    color=discord.Color.red(),
                )
            )
            return
        ...
        while True:
            ...
            await cur.execute(
                "UPDATE info SET viewed = ? WHERE member_id = ?",
                (str(viewed), ctx.author.id),
            )
            await con.commit()
            await cur.close()
            await con.close()
            ...
            if loop == True:
                ...
                if not str(ctx.author.id) in old_views:
                    ...
                    await cur.execute(
                        "UPDATE video SET old_views = ? WHERE link = ?",
                        (str(old_views), data[i][0]),
                    )
                    await cur.execute(
                        "UPDATE video SET views = ? WHERE link = ?",
                        (
                            data[i][3] + 1
                            if int(data[i][8]) != ctx.author.id
                            else data[i][3] + 0,
                            data[i][0],
                        ),
                    )
                    await cur2.execute(
                        "UPDATE channel SET views = ? WHERE member_id = ?",
                        (channel_data[7] + 1, data[i][8]),
                    )
                ...
                msg = await ctx.send(
                    embed=discord.Embed(
                        title="..."
                        if not ctx.channel.is_nsfw() and data[i][12] == "y"
                        else data[i][1],
                        url=""
                        if not ctx.channel.is_nsfw() and data[i][12] == "y"
                        else data[i][0],
                    ...
                    components=[
                        ActionRow(
                            ...
                            Button(
                                ...
                                in ast.literal_eval(channel_data[11])
                                else False,
                            ),
                            Button(
                                style=ButtonStyle.green,
            ...
            try:
                while True:
                    try:
                        ...
                        inter = await ctx.wait_for_button_click(
                            lambda inter: inter.message == msg
                            or inter.message == file
                ...
                if button_id == "subs-button":
                    ...
                    info = await info_cur.execute(
                        "SELECT subscribed FROM info WHERE member_id = ?",
                        (ctx.author.id,),
                    )
                    info = await info.fetchone()
                    info_data = ast.literal_eval(info[0])
                    info_data.append(data[i][10])
                    await info_cur.execute(
                        "UPDATE info SET subscribed = ? WHERE member_id = ?",
                        (str(info_data), ctx.author.id),
                    )
                    ...
                    if not str(ctx.author.id) in subs:
                        ...
                        await cur2.execute(
                            "UPDATE channel SET subscribers = subscribers + 1 WHERE member_id = ?",
                            (channel_data[0],),
                        )
                        await cur2.execute(
                            "UPDATE channel SET old_subs = ? WHERE member_id = ?",
                            (str(subs), channel_data[0]),
                        )
                        await con2.commit()
                    ...
                    if not str(ctx.author.id) in likes:
                        ...
                        await cur2.execute(
                            "UPDATE channel SET likes = ? WHERE member_id = ?",
                            (channel_data[5] + 1, data[i][8]),
                        )
                        ...
                        await cur3.execute(
                            "UPDATE info SET liked = ? WHERE member_id = ?",
                            (str(info_data_), ctx.author.id),
                        )
                        await con3.commit()
                        await cur3.close()
                        await con3.close()
                    ...
                    if str(ctx.author.id) in dislikes:
                        ...
                        await cur.execute(
                            "UPDATE video SET old_dislikes = ? WHERE link = ?",
                            (str(dislikes), str(data[i][0])),
                        )
                        await cur.execute(
                            "UPDATE video SET dislikes = ? WHERE link = ?",
                            (data[i][5] - 1, str(data[i][0])),
                        )
                        await cur2.execute(
                            "UPDATE channel SET dislikes = ? WHERE member_id = ?",
                            (channel_data[6] - 1, data[i][8]),
                        )
                        try:
                            con3 = await helper.connect("db/info.db")
                            cur3 = await helper.cursor(con3)
                            ...
                            await cur3.execute(
                                "UPDATE info SET disliked = ? WHERE member_id = ?",
                                (str(info_data_), ctx.author.id),
                            )
                            await con3.commit()
                            await cur3.close()
                    ...
                    await cur.execute(
                        "UPDATE video SET old_likes = ? WHERE link = ?",
                        (str(likes), str(data[i][0])),
                    )
                    await cur.execute(
                        "UPDATE video SET likes = ? WHERE link = ?",
                        (int(data[i][4]) + 1, str(data[i][0])),
                    )
    ...
    @commands.command(
        "search", description="Search up videos that got posted by other members!"
    )
    @commands.cooldown(1, 10, commands.BucketType.user)
        ...
        if len(data) > 1:
            while True:
                ...
                try:
                    ...
                    while True:
                        try:
                            inter = await ctx.wait_for_button_click(
                                lambda inter: inter.message.id == msg.id
                                or inter.message.id == file.id
                                and inter.channel == ctx.channel,
                                timeout=100,
                            )
                    ...
                    if button_id == "right-button":  # Right Button
                        ...
                        likes = ast.literal_eval(data[i][6])  # list member who likes
                        dislikes = ast.literal_eval(
                            data[i][7]
                        )  # list member who dislikes
                        await cur2.execute(
                            "UPDATE channel SET likes = ? WHERE member_id = ?",
                            (channel_data[5] + 1, data[i][8]),
                        )
            ...
            msg = await ctx.send(
                embed=discord.Embed(
                    ...
                    description="Found 0 result! Try again with diffreant query",
                    color=self.embed_color,
                )
            )
    ...
    @commands.command(
        "setting",
        description="Setting up your channel and profile info",
        aliases=["set"],
    )
    @commands.cooldown(1, 10, commands.BucketType.user)
    async def _setting(self, ctx):
                ...
                SelectMenu(
                    ...
                    options=[
                        SelectOption(
                            "Channel Name",
                            "channel",
                            description="Set a new channel name!",
                            emoji="\U0001f4db",
                        ),
                        SelectOption(
                            "Channel Description",
                            "description",
                            description="Set a new channel description. Need to set limit later!",
                            emoji="\U0001f6d1",
                        ),
                        SelectOption(
                            "Channel Banner",
                            "banner",
                            description="Set a new channel banner!",
                            emoji="\U0001f5bc",
                        ),
                        SelectOption(
                            "User Gender",
                            "gender",
                            description="Set your new gender!",
                            emoji="\U00002642",
                        ),
                        SelectOption(
                            "User email",
                            "email",
                            description="Set your new email. Must not have special characters\nMust be a minimum of 5 to 13 characters",
                            emoji="\U0001f4e7",
                        ),
                        SelectOption(
                            "User Password",
                            "password",
                            description="Set your new password. Must not have special characters\nMust be a minimum of 5 to 13 characters",
                            emoji="\U0001f6c2",
                        ),
                    ],
                )
        ...
        try:
            while True:
                try:
                    inter = await embed.wait_for_dropdown(
                        check=lambda inter: inter.author == ctx.author, timeout=10
                    )
                    if inter.author != ctx.author:
                        await inter.reply(
                            embed=discord.Embed(
            ...
            if value == "channel":
                await inter.reply(
                    embed=discord.Embed(
                        ...
                        color=self.embed_color,
                    ).set_footer(text="You have 120 seconds to do this")
                )
                msg = await self.bot.wait_for(
                    "message",
                    check=lambda x: x.author == ctx.author and x.channel == ctx.channel,
                ...
                await cur.execute(
                    "UPDATE channel SET channel = ? WHERE member_id = ?",
                ...
                await cur.execute(
                    "UPDATE channel SET description = ? WHERE member_id = ?",
                    (msg.content, ctx.author.id),
                )
                await ctx.send(
                    embed=discord.Embed(
                ...
                if msg.attachments or msg.content.startswith("http"):
                    if msg.attachments:
                        for x in msg.attachments:
                            await cur.execute(
                                "UPDATE channel SET banner = ? WHERE member_id = ?",
                                (str(x), ctx.author.id),
                            )
                            await ctx.send(
                                embed=discord.Embed(
            ...
            # =================================================
                    ...
                    components=[
                        SelectMenu(
                            ...
                            options=[
                                ...
                                SelectOption(
                                    "NonBinary", "value 3", emoji="\U00002b1c"
                                ),
                            ],
                        )
                    ],
                ...
                try:
                    gender = await Message.wait_for_dropdown(
                        check=lambda inter: inter.author == ctx.author, timeout=10
                    )
                except asyncio.TimeoutError:
                    await ctx.send(
                ...
                label = "".join(
                    [option.label for option in gender.select_menu.selected_options]
                )
                await gender.reply(
                    embed=discord.Embed(
                ...
                await info.execute(
                    "UPDATE info SET gender = ? WHERE member_id = ?",
                    (label, ctx.author.id),
                )
                ...
                await info.execute(
                    "UPDATE info SET email = ? WHERE member_id = ?",
                    (msg.content, ctx.author.id),
                )
                await ctx.send(
                    embed=discord.Embed(
                ...
                await info.execute(
                    "UPDATE info SET password = ? WHERE member_id = ?",
                    (msg.content, ctx.author.id),
                )
                await ctx.send(
                    ctx.author.mention,
            ...
            await ctx.send(
                embed=discord.Embed(description="Too late, type the command again")
            )
            return
    ...
    @commands.command(
        "login",
        description="Use for login to your account by entering the account email and password!",
    )
    @commands.cooldown(1, 10, commands.BucketType.user)
    async def _login(self, ctx):
        ...
        if not data or not channel:
            await ctx.send(
                "Oops you are not in the database! To be able to login to existing accounts you need to make your own account first using `p!start` command then use `p!login` again!"
            )
            return
        ...
        if data[2] == "no" or not data:
            ...
            async def _green(inter):
                ...
                msg = await ctx.send(
                    ...
                    .set_author(
                        name=f"{ctx.author.name} (@{channel[1]})", icon_url=channel[3]
                    )
                    .set_footer(
                    ...
                    .add_field(
                        name="<:Follow_Icon:885087513058902057> Subs", value=channel[4]
                    )
                    .add_field(
                        name="<:blurple_camera:875659362331394058> Videos",
                        value=channel[8],
                    )
                    .add_field(name="🫂 Views", value=channel[7])
                    .add_field(
                        name="<:likes:875659362343993404> Likes", value=channel[5]
                    )
                    .add_field(
                        name="<:dislikes:875659362264309821> Dislikes", value=channel[6]
                    )
                    .add_field(name="\u200b", value="\u200b")
                    .add_field(
                        name="Account Information",
                    ...
                    .add_field(name="🫂 Gender", value=data[1])
                    .add_field(name="📧 email", value=data[3])
                    .add_field(
                        name="🔑 Password", value="||[Password Redacted]||", inline=False
                    )
                    .add_field(name="⌛ Account Age", value=data[5]),
                    components=[
                        ActionRow(
                            Button(
                                style=ButtonStyle.green,
                ...
                async def _Green(inter):
                    ...
                    if data[0] == ctx.author.id:
                        await cur.execute(
                            "UPDATE info SET verified = ? WHERE email = ?",
                            (y, raw_email),
                        )
                        await con.commit()
                        await cur.close()
                        ...
                        await inter.reply(
                            ...
                            .add_field(
                                name="<:Follow_Icon:885087513058902057> Subs",
                                value=channel[4],
                            )
                            .add_field(
                                name="<:blurple_camera:875659362331394058> Videos",
                        ...
                        await ctx.send(
                            "For now you can only access to an account that you create with `p!start` command! This will be fix later!"
                        )
                        # con=await helper.connect("db/info.db")
                        # cur=await helper.cursor(con)
    ...
    async def _logout(self, ctx):
        ...
        async def _Green_(inter):
            ...
            cur = await helper.cursor(con)
            await cur.execute(
                "UPDATE info SET verified = ? WHERE member_id = ?",
                ("no", ctx.author.id),
            )
    ...
    @commands.command(
        "comment",
        description="Comment a video! make sure to only provide the video id if you want to view all comments if not then provide the comment msg to comment a video!",
    )
    @commands.cooldown(1, 10, commands.BucketType.user)
    async def _comment(self, ctx, video_id, *, msg=None):
        ...
        if msg:
            ...
            await cur.execute(
                "SELECT commenter_id, content, comment_id, date FROM comments WHERE video_id = ?",
                (video_id,),
            )
            ...
            for id in data:
                ...
                if counter == 5:
                    em = discord.Embed(
                        ...
                        description=txt,
                        color=self.embed_color,
                    ).set_author(name=f"Creator @{creator[1]}", icon_url=creator[3])
                    counter = 0
                    txt = ""
                    embeds.append(em)
    ...
    async def _delete(self, ctx, ID):
        ...
        msg = await ctx.send(
            ...
            embed=discord.Embed(
                title="..."
                if not ctx.channel.is_nsfw() and data[14] == "y"
                else data[1],
            ...
            .set_author(
                name=f"{ctx.author.name} (@{channel_data[1]})", icon_url=channel_data[3]
            ),
            components=[
                ActionRow(
                    Button(
        ...
        file = await ctx.send(
            "Search this video in nsfw channel!"
            if data[14] == "y" and not ctx.channel.is_nsfw()
            else data[3],
            components=[
                ActionRow(
                    Button(
        ...
        async def _green(inter):
            ...
            await cur.execute(
                "UPDATE channel SET videos = videos - 1 WHERE member_id = ?",
                (ctx.author.id,),
            )
            await cur.execute(
                "UPDATE channel SET views = ? WHERE member_id = ?",
                (channel_data[7] - data[4], ctx.author.id),
            )

            await cur.execute(
                "UPDATE channel SET likes = ? WHERE member_id = ?",
                (channel_data[5] - data[5], ctx.author.id),
            )
            await cur.execute(
                "UPDATE channel SET dislikes = ? WHERE member_id = ?",
                (channel_data[6] - data[6], ctx.author.id),
            )
            await con.commit()
            await cur.close()
            await con.close()

            await inter.reply(type=7, content="deleted the video!", components=[])
        ...
        if len(data) > 1:
            while True:
                ...
                while True:
                    try:
                        inter = await ctx.wait_for_button_click(
                            lambda inter: inter.author == ctx.author
                ...
                if inter.clicked_button.custom_id == "left-button":  # Left Button
                    ...
                    try:
                        ...
                        while True:
                            ...
                            if page > len(data):
                                await ctx.send(
                                    "Number is Too large, enter it again with smaller one"
                                )
                                await asyncio.sleep(0.5)

                            elif page <= 0:
                                await ctx.send(
                                    "Number cannot be minus, zero, or letters enter it again with bigger one"
                                )
                                await asyncio.sleep(0.5)
    ...
    @commands.command(
        "recent",
        description="Give you the most recent video! if you dont provided the max videos it will give 10 automaticaly",
    )
    async def _recent(self, ctx, max=10):
        ...
        while True:
            ...
            await cur.execute("SELECT * FROM video WHERE verified = ?", ("y",))
            data = await cur.fetchall()
            ...
            try:
                if loop == True:
                    ...
                    if not str(ctx.author.id) in old_views:
                        ...
                        await cur.execute(
                            "UPDATE video SET old_views = ? WHERE link = ?",
                            (str(old_views), data[i][3]),
                        )
                        await cur.execute(
                            "UPDATE video SET views = ? WHERE link = ?",
                            (
                                data[i][4] + 1
                                if int(data[i][0]) != ctx.author.id
                                else data[i][4] + 0,
                                data[i][3],
                            ),
                        )
                        ...
                        components=[
                            ActionRow(
                                ...
                                Button(
                                    ...
                                    custom_id="dislike-button",
                                    disabled=True
                                    if str(ctx.author.id) in data[i][8]
                                    else False,
                                ),
                                Button(
                                    style=ButtonStyle.grey,
                ...
                if button_id == "right-button":  # Right Button
                    ...
                    if str(ctx.author.id) in dislikes:
                        ...
                        await cur.execute(
                            "UPDATE video SET old_dislikes = ? WHERE link = ?",
                            (str(dislikes), str(data[i][3])),
                        )
                        await cur.execute(
                            "UPDATE video SET dislikes = ? WHERE link = ?",
                            (data[i][6] - 1, str(data[i][3])),
                        )
                        await cur2.execute(
                            "UPDATE channel SET dislikes = ? WHERE member_id = ?",
                            (channel_data[6] - 1, data[i][0]),
                        )
                    ...
                    await cur.execute(
                        "UPDATE video SET old_likes = ? WHERE link = ?",
                        (str(likes), str(data[i][3])),
                    )
                    await cur.execute(
                        "UPDATE video SET likes = ? WHERE link = ?",
                        (int(data[i][5]) + 1, str(data[i][3])),
                    )
    ...
    @commands.command(
        "history",
        description="Show a list of videos that you viewed before! If you dont provided max_video, it will automatically send 10!",
    )
    ...
    async def _reupload(self, ctx, video_ID):
        ...
        if not data:
            await ctx.send(
                embed=discord.Embed(
                    description="You put a wrong ID!", color=discord.Color.red()
                )
            )
            return
        ...
        try:
            await cur.execute(
                "UPDATE video SET deleted = ? WHERE ID = ?", ("n", video_ID)
            )
            await con.commit()
            await cur.close()
            await con.close()
            ...
            await ctx.send(
                f"You reuploaded that video! Check it using `p!view {video_ID}`"
            )
        except Exception as e:
            raise e
    ...
    @commands.command(
        "subscribed",
        description="Display channels that you subscribed",
        aliases=["subscribe", "following"],
    )
    @commands.cooldown(1, 10, commands.BucketType.user)
    async def _subscribed(self, ctx):
        ...
        await cur.execute(
            "SELECT subscribed FROM info WHERE member_id = ?", (ctx.author.id,)
        )
    ...
    @commands.command(
        "liked", description="Search up video that you liked from the most recent video"
    )
    async def _liked(self, ctx):
        channel = await helper.find_in_channel(ctx.author.id)
        info = await helper.find_in_info(ctx.author.id)
        sets = set()
        if not channel or not info:
            await ctx.send(
                embed=discord.Embed(
                    description="You already made an account", color=discord.Color.red()
                )
        ...
        for id in raw_data:
            data.insert(
                0, id
            )  # Reverse the list without using sort or sorted which sort it
        ...
        while True:
            raw_date = datetime.datetime.fromtimestamp(int(data[i][10]))
            channel = await helper.find_in_channel(data[i][0])
            user = await self.bot.fetch_user(channel[0])
            date_time = raw_date.strftime("%m/%d/%Y")
            msg = await ctx.send(
                embed=discord.Embed(
                    title="..."
                ...
                .set_author(name=f"{user.name} (@{channel[1]})", icon_url=channel[3]),
                components=[
                    ActionRow(
                        Button(
                            style=ButtonStyle.blurple,
    ...
    @commands.command(
        "disliked",
        description="Search up video that you disliked from the most recent video",
    )
    async def _disliked(self, ctx):
        channel = await helper.find_in_channel(ctx.author.id)
        info = await helper.find_in_info(ctx.author.id)
        sets = set()
        if not channel or not info:
